...
const ALICE_SEED: [u8; 32] = [1; 32];
const BOB_SEED: [u8; 32] = [2; 32];
...
impl Account {
    ...
    /// Returns a [`SignedTransaction`] with no arguments and this account as the sender.
    pub fn create_signed_txn_with_program(
        &self,
        program: Program,
        sequence_number: u64,
        max_gas_amount: u64,
    ...
    pub fn read_account_resource(blob: &[u8], account_type: StructDef) -> Option<Value> {
...
impl AccountData {
    ...
    pub fn new_with_account(account: Account, balance: u64, sequence_number: u64) -> Self {
